    ...
    <div class="container py-4">
        <div class="row">
            ...
            <div class="col-md-4 text-center">
                <img src="@/assets/image/story-thumnail.jpg" fit="cover" style="width: 70%; border-radius: 12px;" />
            </div>

            <!-- Cột nội dung -->
            <div class="col-md-8">
                <!-- Tiêu đề + rating -->
                <h3 class="fw-bold">Âm mưu tình yêu của tôi</h3>
                ...
                <div class="el-descriptions-storyinfo">
                    <el-descriptions label-width="150px" :column="4" direction="vertical" size="small" class="mb-3">
                        <el-descriptions-item label="Tác giả"><span class="fw-bold">Tử Tiểu
                                Miêu</span></el-descriptions-item>
                ...
                <div class="el-descriptions-storyinfo border-top border-bottom border-opacity-50 pt-3">
                    <el-descriptions label-width="120px" :column="4" direction="vertical" size="small" class="mb-3">
                        <el-descriptions-item><span class="fw-bold">112 chương</span></el-descriptions-item>
                        <el-descriptions-item><span class="fw-bold">15.645 lượt đọc</span></el-descriptions-item>
                ...
                <div>
                    <button class="btn-alert  d-flex align-items-center"> <img src="@/assets/icon/book.png" alt=""><span
                            class="fw-bold"> Đọc truyện ngay</span></button>
                </div>
                <!-- Mô tả -->
                <p class="text-secondary mt-5">
                    Tưởng Thiên Du - cảnh sát đặc nhiệm tại ngũ - bị thương nặng và rơi vào hôn mê sâu trong một lần
                    thực hiện nhiệm vụ. Đến lúc mở mắt ra, cô ngạc nhiên phát hiện mình đang ở trong một cơ thể xa lạ,
                    hơn nữa còn trở thành nghi phạm của một vụ án nghiêm trọng. Không kịp suy xét rõ ràng tình huống
                    hiện tại, cô lại bị cuốn vào vụ án bắt cóc con tin ở bệnh viện. Vì thế, ngay lúc mọi người còn chưa
                    kịp phản ứng gì, kẻ bắt cóc hung ác cầm dao đã bị người ta ném lật xuống đất, mà người khống chế gã
                    lại chính là bệnh nhân vừa thoát khỏi cơn nguy kịch không lâu.
                    Đám đông đứng xem: ??? Tổ trưởng Tổ Trọng án Kỳ Tử Ngang - vừa biết tin nghi phạm trong vụ án đã
                    tỉnh dậy lập tức lao ngay đến bệnh viện: ???
                    Tưởng Thiên Du: Toàn tâm toàn...
                    <el-link type="primary">Xem thêm</el-link>
                </p>
                <div class="mt-5">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <h3 class="fw-bold">Danh sách chương (32)</h3>
                        ...
                        <el-table :data="chapters" style="width: 100%">
                            <el-table-column min-width="200">
                                <template #default="scope">
                                    <p class="fw-semibold">{{ scope.row.title }}</p>
                                </template>
                            </el-table-column>
                            <el-table-column min-width="100">
                                <template #default="scope">
                                    <p class="fw-semibold">{{ scope.row.words }}</p>
                                </template>
                            </el-table-column>
                            <el-table-column>
                                <template #default>
