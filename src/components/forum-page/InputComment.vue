<template>
    <div class="comment-box px-3 pb-2 pt-3 mt-3">
        <div class="post-main__info d-flex justify-content-between gap-1">
            <div class="d-flex align-items-start">
                <img style="max-width: 40px;" src="@/assets/image/avatar-author-post4.png" alt="">
            </div>
            <el-mention v-model="value" type="textarea" placeholder="Thêm bình luận của bạn"
                style="height: 100px; resize: none;" />
        </div>
        <div class="d-flex justify-content-end">
            <button class="btn-alert d-flex align-items-center gap-2">
