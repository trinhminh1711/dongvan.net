    ...
    <div class="box-shadow px-3 pb-2 pt-3 mt-3">
        <div class="post-main__info d-flex align-items-center justify-content-between gap-1">
            <div class="d-flex align-items-center">
                <img style="max-width: 40px;" :src="user_thumbnail" alt="">
            ...
            <div class="post-comment">
                <p class="like-share d-flex gap-4 py-2">
                    <span @click="incrementLike()" class="d-flex align-items-center gap-2 text-md">
                        <svg :class="localLike < 1 ? 'heart-icon-unliked' : 'heart-icon-liked'" width="22" height="20"
...
async function incrementLike() {
    localLike.value += 1;
    const res = await increaseLike(props.comment_id)
