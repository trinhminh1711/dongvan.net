            ...
            <div v-for="stories in categoryList" :key="stories.id" class="box-left__content col-6">
                ...
                <div class="left-content">
                    ...
                    <p class="text-sm"> Chương đang đọc: [Chương 1] Trùng Sinh Tỉnh Lại </p>
                     <button v-if="!stories.statusComplete" class="btn-alert my-4">Đăng Chương</button>
                      <button v-if="stories.statusComplete" class="btn-success my-4">Hoành thành</button>
                </div>
            </div>
        </div>
